...
document.addEventListener("DOMContentLoaded", () => {
    ...
    sampleButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        lockButtons();
        try {
            yield loadSample("Lenna");
        }
        finally {
            unlockButtons();
        }
    }));
    sampleAnimationButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        clearMessage();
        lockButtons();
        try {
            yield loadSample("spinfox");
        }
        finally {
            unlockButtons();
        }
...
function decodeSelectedFile(file) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const memory = {};
        try {
            yield libflif.decode(file, result => showRaw(result, memory), getDecodeOption());
...
function encodeCommon(frames, displayName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const memory = {};
        try {
            yield libflif.decode(encodeResult, result => showRaw(result, memory), getDecodeOption());
            stackMessage("Successfully decoded.");
        }
        catch (err) {
            stackMessage(`Decoding failed: ${err.message || "Unspecified error, please check console message."}`);
...
function getDecodeOption() {
    return { progressiveInitialLimit: disableProgressiveBox.checked ? 10000 : 0 };
}
function loadSample(sampleFileName) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`sample/${sampleFileName}.flif?0.2.0rc18`);
        const arrayBuffer = yield response.arrayBuffer();
        stackMessage("Decoding...");
        const memory = {};
        try {
            yield libflif.decode(arrayBuffer, result => showRaw(result, memory), getDecodeOption());
            stackMessage("Successfully decoded.");
        }
        catch (err) {
            stackMessage(`Decoding failed: ${err.message || "Unspecified error, please check console message."}`);
