...
document.addEventListener("DOMContentLoaded", () => {
    ...
    encodeAnimationButton.addEventListener("change", () => __awaiter(this, void 0, void 0, function* () {
        ...
        lockButtons();
        try {
            yield encodedSelectedAnimation(encodeAnimationButton.files[0]);
        }
        finally {
            unlockButtons();
        }
...
function encodedSelectedAnimation(file) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let encodeResult;
        try {
            encodeResult = yield libflif.encode({ frames, loop: exportResult.loopCount });
            stackMessage(`Successfully encoded as ${(encodeResult.byteLength / 1024).toFixed(2)} KiB FLIF file and now decoding again by libflif.js....`);
        }
        catch (err) {
            stackMessage(`Encoding failed: ${err.message || "Unspecified error"}`);
